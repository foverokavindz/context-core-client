...
description: Use when adding, changing, or consuming a REST API endpoint in a React + TypeScript app that follows the IApiClient/AxiosClient/service/component layering — creating a service method, its request/response types, or wiring an endpoint into a component. Covers the ApiResponse envelope and the never-throw invariant.
---
